...
class PlanningCache {
  ...
  // -------------------------------------------------------------------------
  // Legacy model_profiles compatibility boundary
  // -------------------------------------------------------------------------
  //
  // Phase 169 removes the planning-cache read/write helpers that used to make
  // SQLite-backed model_profiles look like a live model-selection API. The
  // compatibility table may still exist on disk for historical migrations, but
  // canonical config resolution is now the only supported source of truth.
