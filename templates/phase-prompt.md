...
@/home/cam/.config/opencode/get-shit-done/references/checkpoints.md
</execution_context>
...
<!-- For checkpoint task examples and patterns, see @/home/cam/.config/opencode/get-shit-done/references/checkpoints.md -->
<!-- Key rule: The agent starts dev server BEFORE human-verify checkpoints. User only visits URLs. -->
...
See `/home/cam/.config/opencode/get-shit-done/references/tdd.md` for TDD plan structure.
...
See `/home/cam/.config/opencode/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `/home/cam/.config/opencode/get-shit-done/workflows/verify-phase.md` for verification logic.
