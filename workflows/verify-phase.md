...
for plan in "$PHASE_DIR"/*-PLAN.md; do
  node __OPENCODE_CONFIG__/get-shit-done/bin/gsd-tools.cjs util:frontmatter get "$plan" --field must_haves
done
```
...
```bash
node __OPENCODE_CONFIG__/get-shit-done/bin/gsd-tools.cjs plan:roadmap get-phase "${phase_number}"
```
