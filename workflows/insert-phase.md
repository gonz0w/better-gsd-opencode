...
Example: `/bgsd roadmap insert 72 Fix critical auth bug`
-> after = 72
...
Usage: /bgsd roadmap insert <after> <description>
Example: /bgsd roadmap insert 72 Fix critical auth bug
```
...
- Don't use this for planned work at end of milestone (use /bgsd roadmap add)
