...
```bash
node __OPENCODE_CONFIG__/get-shit-done/bin/gsd-tools.cjs execute:commit "chore: archive phase directories from completed milestones" --files .planning/milestones/ .planning/phases/
```
