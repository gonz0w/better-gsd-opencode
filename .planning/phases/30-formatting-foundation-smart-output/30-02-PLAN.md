...
```bash
# Before:
RESULT=$(node /home/cam/.config/opencode/get-shit-done/bin/gsd-tools.cjs some-command --raw 2>/dev/null)
# After:
RESULT=$(node /home/cam/.config/opencode/get-shit-done/bin/gsd-tools.cjs some-command 2>/dev/null)
```
