...
**Plans:**
  - Plan 01 (Wave 1): Decision functions (resolveAgentCapabilityLevel, resolvePhaseDependencies) + capability-aware context filtering
...
| 128. Agent Collaboration | 0/3 | Planned | — |
