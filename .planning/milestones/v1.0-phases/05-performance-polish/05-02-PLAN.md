...
Purpose: Different users may have different model context windows (100K for smaller models, 200K for larger models) and different target utilization. Making this configurable lets the tool give accurate warnings.
