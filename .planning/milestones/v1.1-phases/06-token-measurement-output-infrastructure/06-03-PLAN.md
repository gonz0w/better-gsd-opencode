...
Purpose: This is the "proof" command — after Phase 8 compresses workflows, running `context-budget compare` will show exactly how many tokens were saved per workflow and whether the 30% target was hit. Without this, the only way to verify reduction is manual calculation.
