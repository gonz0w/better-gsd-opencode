...
- [x] **RBND-02**: Environment variable `GSD_HOME` renamed to `BGSD_HOME` across plugin, CLI, workflows, agents, and skills
...
| RBND-02 | Phase 72 | Complete | grep BGSD_HOME plugin.js |
